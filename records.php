<?php include("include/header.php"); ?>
	...
	<li>
		<div class="collapsible-header"> Date 1</div>
	...
	<li>
		<div class="collapsible-header"> Date 2 </div>
		<div class="collapsible-body"> B2</div>
	</li>
	<li>
		<div class="collapsible-header"> Date 3 </div>
		<div class="collapsible-body"> C2</div>
	</li>
